...
# TODO CentOS repo
# TODO Use CentOS for automated install
# TODO Aur 4
...
class Clients(object):
    ...
    def disconnected(self, client):
        ...
        # TODO Remove from self.collection
        # TODO Clean self.collection on server stop use task to clean
    ...
    def add_ip(self, client_id, address):
        self.ips[address] = client_id

    def add_dyn_ip(self, client_id, address):
        self.ips[address] = client_id
        self.dyn_ips[address] = client_id
            ...
            try:
                ...
                try:
                    ...
                    if not response['updatedExisting']:
                        # TODO Test by removing doc while connected
