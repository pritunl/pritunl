...
DEFAULT_ORG_POOL_SIZE = 1
DEFAULT_USER_POOL_SIZE = 6
DEFAULT_SERVER_USER_POOL_SIZE = 2
DEFAULT_SERVER_POOL_SIZE = 2
DEFAULT_DH_PARAM_BITS_POOL = ['1536', '2048']
DEFAULT_OTP_SECRET_LEN = 16
DEFAULT_SERVER_LOG_LINES = 1024
